...
builds render the same way at `/v/<build>/`, and the experimental build (when
...
| `/classes/` | `src/generate/render/hierarchy.js` |
| `/classes/index/`, `/classes/<letter>/`, `/classes/members/…` | `src/generate/render/classes.js` |
