...
const PAGES = [
  ...
  ['Release notes', 'release-notes/', 'Every documented PC stable build, with its script revision and forum thread'],
  ['Deprecated', 'deprecated/', 'Declarations marked Obsolete or @deprecated, with their replacements'],
  ['Classes', 'classes/', 'Inheritance tree of every Enforce Script class'],
  ['Hierarchy', 'classes/', 'What extends what, from engine types down through every scripted subclass'],
  ['Class Index', 'classes/index/', 'All class names, alphabetically'],
