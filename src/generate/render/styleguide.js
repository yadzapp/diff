...
<thead><tr><th>Specimen</th><th>Classes</th></tr></thead>
<tbody>
${row('Small · Gray', '<button type="button" class="icon-btn icon-btn-sm icon-btn-gray hist-btn text-xs font-semibold tabular-nums leading-none" aria-label="Changes, 20 builds" data-tip="What changed in this type">20</button> <a class="icon-btn icon-btn-sm icon-btn-gray file-btn" href="#" aria-label="View source" data-tip="View source"><i class="ic ic-file" aria-hidden="true"></i></a> <span class="llm-copy copy-llm relative inline-flex"><button type="button" class="icon-btn icon-btn-sm icon-btn-gray copy-btn" aria-label="Copy for AI" data-tip="Copy for AI" aria-haspopup="menu" aria-expanded="false"><i class="ic ic-llm" aria-hidden="true"></i></button></span> <a class="icon-btn icon-btn-sm icon-btn-gray note-ask" href="#" aria-label="Suggest a community note" data-tip="Suggest a community note"><i class="ic ic-note" aria-hidden="true"></i></a>')}
