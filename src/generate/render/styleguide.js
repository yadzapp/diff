...
${row('note-tag note-tag-warn · picker', '<div class="ver-group" style="position:static;margin:0;width:220px">DayZ 1.30<span class="note-tag note-tag-warn ml-auto">experimental</span></div>')}
