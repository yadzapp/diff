...
import { layout, EXT, linkedH2 } from '../html.js';
...
<p>It's a browsable documentation for the <a href="https://community.bistudio.com/wiki/DayZ:Enforce_Script_Syntax" ${EXT}>DayZ Enforce Script</a> sources. Every class, method, enum and constant, generated automatically from the official <a href="https://github.com/BohemiaInteractive/DayZ-Script-Diff" ${EXT}>DayZ Script Diff</a> repository. <a href="/mod-check/">Mod check</a> also uses a signature snapshot from <a href="https://github.com/BohemiaInteractive/DayZ-Script-Diff-Experimental" ${EXT}>DayZ Script Diff Experimental</a>. It's <a href="${REPO_URL}" ${EXT}>open source</a> and built by the community.</p>
...
${linkedH2('collaborations', 'Collaborations')}
