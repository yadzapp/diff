...
export function renderAbout(ctx) {
  const content = /* html */ `
<h1>About</h1>
<p>DIFF stands for DayZ Internal File Finder by <a href="https://yadz.app/" ${EXT}>YADZ</a>.</p>
