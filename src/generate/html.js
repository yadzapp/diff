...
<div class="side-set">
<div class="verpicker">
<button class="select-ghost ver-btn" id="verBtn" aria-haspopup="true" aria-expanded="false" aria-label="Change build"><span class="ver-label"></span><i class="ic ic-circle-alert size-3.5 text-kw" id="verExp" hidden data-tip="Experimental build" aria-hidden="true"></i><i class="ic ic-chev"></i></button>
