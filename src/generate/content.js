...
export const OFFICIAL_MODDING_LINKS = alpha([
  ...
  ['Script Diff', 'https://github.com/BohemiaInteractive/DayZ-Script-Diff', 'Official Enforce Script sources between game versions — what this site is built from',
    [['Experimental', 'https://github.com/BohemiaInteractive/DayZ-Script-Diff-Experimental']]],
  ...
  ['Misc', 'https://github.com/BohemiaInteractive/DayZ-Misc', 'Additional official resources Bohemia publishes for modders'],
]);
...
export const COMMUNITY_SECTIONS = [
  {
    ...
    links: alpha([
      ...
      ['Community Samples', 'https://github.com/Thurston00/DayZ-CommunitySamples', 'Sample mods from the community, by the community'],
  ...
  },
  {
    ...
    links: alpha([
      ...
      ['BoutDangTime Tools', 'https://github.com/joetex/DayZ-BoutDangTimeTools', 'Workbench Script Editor environment for DayZ mod development'],
      ...
      ['DayZeEditor', 'https://github.com/Shawminator/DayZeEditor', 'Economy and mod config manager for types, events and related XML'],
      ['DayZEditor', 'https://github.com/MrX13415/DayZEditor', 'Desktop loot-table editor for Standalone economy files'],
      ...
      ['PboSpy', 'https://github.com/rvost/PboSpy', 'Graphical explorer for Bohemia Interactive PBO files'],
    ...
    links: alpha([
      ...
      ['DayZ Expansion', 'https://dayzexpansion.com/', 'Mod framework wiki, guides and configuration',
        [['GitHub', 'https://github.com/salutesh/DayZ-Expansion-Scripts'],
         ['Missions', 'https://github.com/ExpansionModTeam/DayZ-Expansion-Missions'],
         ['Settings', 'https://github.com/ExpansionModTeam/DayZ-Expansion-Settings'],
         ['Market config', 'https://dayzexpansion.com/mods/expansion-market?tab=configuration'],
         ['JSON validator', 'https://dayzexpansion.com/tools/custom/json-validator'],
      ...
      ['ZomBerry Admin Tools', 'https://github.com/Moondarker/ZomBerry-DayZAdminTools', 'Lightweight client/server admin tools with a customizable GUI'],
    ]),
  },
  {
    id: 'agents',
  ...
  },
  {
    ...
    links: alpha([
      ...
      ['DZconfig', 'https://dzconfig.com/', 'Visual editor for types.xml, events, traders and Expansion mission configs',
        [['Wiki', 'https://dzconfig.com/wiki'],
         ['Understanding CE', 'https://dzconfig.com/wiki/understanding-ce'],
         ['Loot balancing', 'https://dzconfig.com/wiki/loot-balancing'],
         ['Heli crash events', 'https://dzconfig.com/wiki/heli-crash-events']]],
      ...
      ['dayz-linux-cli-launcher', 'https://github.com/bastimeyer/dayz-linux-cli-launcher', 'CLI launcher for DayZ on Linux via Proton'],
      ['dayz-server-manager', 'https://github.com/mr-guard/dayz-server-manager', 'Server installer and watchdog with Discord and RCon built in'],
      ['DayzServerTools', 'https://github.com/rvost/DayzServerTools', 'Desktop tools for custom DayZ server and economy setup'],
      ...
      ['dztui', 'https://github.com/aclist/dztui', 'Linux GUI server browser and mod manager'],
      ...
      ['MapLink', 'https://github.com/DaemonForge/DayZ-MapLink', 'Hive player data across modded servers'],
  ...
  },
  {
    ...
    links: alpha([
      ...
      ['DayZ Map DL', 'https://github.com/Samg381/DayZ-Map-DL', 'Generates high-resolution images of DayZ game maps'],
      ["Flynn's Terrain Tools", 'https://github.com/Naviata/FTT-Releases', 'Free Terrain Builder companion: forests, roads, fences, rivers, holes and a 3D flythrough',
        [['Guide', 'https://github.com/Naviata/FTT-Releases/blob/main/GUIDE.md'],
         ['Samples', 'https://github.com/Naviata/FTT-Samples'],
         ['Template libs', 'https://github.com/Naviata/FTT-TemplateLibs']]],
